...
func lucyFun(update tgbotapi.Update) {
	msg := tgbotapi.NewMessage(update.CallbackQuery.Message.Chat.ID, "🎁【测试】抽奖\n\n发起抽奖次数：0    \n\n已开奖：0       未开奖：0       取消：0")
	inlineKeyboard := tgbotapi.NewInlineKeyboardMarkup(
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData("📎发起抽奖活动", "createlucky"),
			tgbotapi.NewInlineKeyboardButtonData("📪查看抽奖记录", "luckyrecord"),
		),
		tgbotapi.NewInlineKeyboardRow(
...
func createlucky(update tgbotapi.Update) {
...
func luckyrecord(update tgbotapi.Update) {

}

func luckysetting(update tgbotapi.Update) {
